/obj/item/gun/projectile/automatic/m16
	...
	one_hand_penalty = 4
	firemodes = list(
		list(mode_name="semiauto",       burst=1,    fire_delay=0,      use_launcher=null, one_hand_penalty=3, burst_accuracy=null, dispersion=null),
		list(mode_name="3-round bursts", burst=3,    fire_delay=0,	    use_launcher=null, one_hand_penalty=5, burst_accuracy=list(0,-0.6,-1.2), dispersion=list(0.4, 0.8, 1.2)),
		list(mode_name="fire grenades",  burst=null, fire_delay=null,   use_launcher=1,    one_hand_penalty=3, burst_accuracy=null, dispersion=null)
		)
...
/obj/item/gun/projectile/automatic/m14
	...
	firemodes = list(
		...
		list(mode_name="short bursts", burst=3, fire_delay=null,      one_hand_penalty=5, burst_accuracy=list(0,-1,-1),       dispersion=list(0.6, 1.0, 1.2)),
		list(mode_name="long bursts",   burst=5, fire_delay=null,      one_hand_penalty=6, burst_accuracy=list(0,-1,-2,-3,-3), dispersion=list(1.0, 1.0, 1.2, 1.2, 1.5)),
		)
