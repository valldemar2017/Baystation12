...
/datum/sprite_accessory/facial_hair/ipc/
	icon = 'icons/mob/human_races/species/ipc/monitor_icons.dmi'
	species_allowed = list(SPECIES_IPC)
	gender = NEUTER
	do_coloration = FALSE
	models_allowed = list("Bishop Monitor.", "Hephaestus Monitor.", "Xion Monitor.", "Ward-Takahashi Monitor.", "Morpheus Monitor.", "Shellguard Monitor.")
...
/datum/sprite_accessory/hair/ipc
	icon = 'icons/mob/human_races/species/ipc/ipc_head_accessories.dmi'
	species_allowed = list(SPECIES_IPC)
	gender = NEUTER
	do_coloration = FALSE
